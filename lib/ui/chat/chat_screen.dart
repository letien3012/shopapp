  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (authState is AuthAuthenticated) {
        context.read<ChatBloc>().add(LoadChatRoomsEvent(authState.user.uid));
      }
    });
  }
              ...
              children: [
                ClipOval(
                  child: Image.network(
                    ...
                    height: 50,
                    fit: BoxFit.cover,
                    'https://img.freepik.com/premium-vector/luxury-lch-logo-design-elegant-letter-lch-monogram-logo-minimalist-polygon-lch-logo-design-template_1101554-79801.jpg', // Thay bằng ảnh của shop nếu có
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text(
                              chatRoom
                                  .shopId, // Thay bằng tên shop thực tế nếu có
                              maxLines: 1,
                        ...
                        Text(
                          chatRoom.lastMessageId ?? "Bắt đầu trò chuyện",
                          style: const TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.w400,
                          ),
                ...
                if (chatRoom.unreadCountBuyer > 0 ||
                  ...
                  Container(
                    ...
                    child: Text(
                      '${chatRoom.unreadCountBuyer + chatRoom.unreadCountShop}',
