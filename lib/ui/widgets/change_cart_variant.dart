...
class _ChangeCartVariantState extends State<ChangeCartVariant> {
  ...
  bool _hasVariantChanged() {
    ...
    if (widget.optionId1 != null && selectedIndexVariant1 != -1) {
      if (product.variants[0].options[selectedIndexVariant1].id !=
          widget.optionId1) {
        return true;
      }
    ...
    if (product.variants.length > 1) {
      ...
      if (widget.optionId2 != null && selectedIndexVariant2 != -1) {
        if (product.variants[1].options[selectedIndexVariant2].id !=
            widget.optionId2) {
          return true;
        }
                            ...
                            widget.parentContext
                                ...
                                .add(UpdateProductVariantEvent(
                                  ...
                                  option1Id: selectedIndexVariant1 != -1
                                      ...
                                      : null,
                                  variant2Id: product.variants.length > 1 &&
                                          selectedIndexVariant2 != -1
                                      ? product.variants[1].id
                                      : null,
                                  option2Id: product.variants.length > 1 &&
                                          selectedIndexVariant2 != -1
                                      ? product.variants[1]
          ...
          : () {
              setState(() {
                if (variantIndex == 0) {
                  ...
                  // Reset variant 2 khi chọn variant 1 mới
                  selectedIndexVariant2 = -1;
